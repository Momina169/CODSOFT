            ...
            <div class="col-lg-12 animated">
                <div class="card">
                    <div class="row no-gutters c1">
                        <div class="col-md-4">
                            <img src="./images/lab2.jpg" alt="Small Picture" class="card-img">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">
            ...
            <div class="col-lg-12 animated">
                <div class="card">
                    <div class="row no-gutters c2">
                        <div class="col-md-4">
                            <img src="./images/lab4.jpg" alt="Small Picture" class="card-img" height="250px">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">
        ...
        <div class="row">
            <div class="col-lg-12 animated">
                <div class="card">
                    <div class="row no-gutters c1">
                        <div class="col-md-4">
                            <img src="./images/sweeper2.jpg" alt="Small Picture" class="card-img" height="260px">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">
        ...
        <div class="row">
            <div class="col-lg-12 animated">
                <div class="card">
                    <div class="row no-gutters c2">
                        <div class="col-md-4">
                            <img src="./images/sweepers3.jpg" alt="Small Picture" class="card-img">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">
