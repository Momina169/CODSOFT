...
<section class="container mt-5 about-section text-center  zoom-effect">
  <div class="row">
    <div class="col-md-12 bg-white zoom-effect">
      ...
      <div class=" d-flex justify-content-center "><hr class="w-25 text-danger border-2"></div>
    ...
    <div style=" padding: 8%; background: linear-gradient(135deg, #E6F7FF, #FFFFFF);">
      ...
      <div class="container">
        <div class="row bg-light">
          ...
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images/cancer.jpeg" alt="" height="120px" width="120px" class="service-image">
            <h6>Cancer Care</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images/emergency.jpg" alt="" height="120px" width="120px" class="service-image">
            <h6> Emergency</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images\nutri (1).jpeg" alt="" height="120px" width="120px" class="service-image">
            <h6>Nutrition</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images/sports.jpeg" alt="" height="120px" width="120px" class="service-image">
            <h6>Sports Medicine</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images/heart.jpg" alt="" height="120px" width="120px" class="service-image">
            <h6>Heart Care</h6>
          </div>
          <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="images/ortho.jpeg" alt="" height="120px" width="120px" class="service-image">
            <h6>Orthopedics</h6>
          </div>
        </div>
      </div>
