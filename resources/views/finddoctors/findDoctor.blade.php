     ...
     <div class="row gx-2 ps-5">
         ...
         <div class="col-sm-4">
             ...
             <ul class="nav flex-column">
                 ...
                 <div>
                     <li class="nav-item">
                         <!-- <a class="nav-link" href="{{route('showDepartments' , $dep->id)}}" data-category="{{ $dep->id }}">{{$dep->DepartmentName}}</a> -->
                         <a class="nav-link" href="{{ url('/doctors/' . $dep->id) }}" data-category="{{ $dep->id }}">{{$dep->DepartmentName}}</a>
                     </li>
                     @endforeach
                 </div>
             </ul>
